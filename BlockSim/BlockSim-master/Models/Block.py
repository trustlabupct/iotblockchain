class Block(object):
    ...
    :param int id: the unique id or the hash of the block
    :param int previous: the unique id or the hash of the previous block
    ...
    def __init__(self,
        ...
        miner=None,
        transactions=[],
        size=0.000546):  # Set size to hold only one transaction
