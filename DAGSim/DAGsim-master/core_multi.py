...
nodos_list = [100]
lambda_list = [48]  # Tasas de generación de transacciones por día
alpha = 0.5
distance = 1
...
for no_of_agents in nodos_list:
    ...
    for lambda_value in lambda_list:
        ...
        simu = Multi_Agent_Simulation(no_of_transactions, lambda_value, no_of_agents, alpha, distance, tip_selection_algo, _printing=True)
        simu.setup()
        simu.run()
        #csv_export2(simu)
        #csv_export(simu)
